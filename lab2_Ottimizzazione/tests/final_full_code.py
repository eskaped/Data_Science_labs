...
def Gradient_Descent(param, epochs = 300000, η = 0.5):
    # cost = []
...
# NOTA: PER PLOTTARE VANDER BISOGNA FARE LA TRASPOSTA (????)
# ax[0].plot(X_arr, Polynomial(X_arr, Gradient_Descent(w)[0], D).T, 'b+')
ax[0].plot(X_arr, Polynomial(X_arr, Gradient_Descent(w), D).T, 'b+')
